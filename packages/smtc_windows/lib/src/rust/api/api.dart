...
}) => RustLib.instance.api.crateApiApiSmtcUpdateConfig(
  internal: internal,
  config: config,
);
...
}) => RustLib.instance.api.crateApiApiSmtcUpdateTimeline(
  internal: internal,
  timeline: timeline,
);
...
}) => RustLib.instance.api.crateApiApiSmtcUpdateShuffle(
  internal: internal,
  shuffle: shuffle,
);
...
Stream<PlatformInt64> smtcPositionChangeRequestEvent({
  required SmtcInternal internal,
}) => RustLib.instance.api.crateApiApiSmtcPositionChangeRequestEvent(
  internal: internal,
);
...
Stream<String> smtcRepeatModeRequestEvent({required SmtcInternal internal}) =>
    RustLib.instance.api.crateApiApiSmtcRepeatModeRequestEvent(
      internal: internal,
    );
